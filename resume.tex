...
\begin{minipage}[t]{1\textwidth}
	...
	\begin{tabular}{ m{0.11\textwidth} m{0.35\textwidth} m{0.11\textwidth} m{0.35\textwidth} }
		\textbf{2024}      & \textbf{Stage (6 mois)}           & \textbf{2019} & \textbf{Travail Saisonnier}    \\
		                   & \textit{Développeur Full Stack}   &               & \textit{Traitement de Données} \\
		                   & \textit{AXA WebCenter, Wasquehal} &               & \textit{Capdune, Dunkerque}    \\
		                   &                                   &               &                                \\
		\textbf{2021-2023} & \textbf{Travail Saisonnier}       & \textbf{2014} & \textbf{Stage Pratique}        \\
		                   & \textit{Agent Outils}             &               & \textit{Développeur}           \\
		                   & \textit{Dillinger France}         &               & \textit{Aurea, Lille}          \\
	\end{tabular}
\end{minipage}
